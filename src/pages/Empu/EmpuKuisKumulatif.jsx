...
class EmpuKuisKumulatif extends Component {
    state = {
        error: null,
        loading: false,
        routeParams: {
    ...
    componentDidMount = () => {
        ...
        this.props.getRekapKumulatif(this.state.routeParams).then((result)=>{
            let label = []
            let data = []
            let arrData = []
            ...
            this.setState({
                ...
                this.props.getRekapBulananKumulatif(this.state.routeParamsBulan).then((result)=>{
                    let labelBulanan = []
                    let dataBulanan = []
                    let arrDataBulanan = []
    ...
    render()
    {
        ...
        return (
            <Page name="EmpuKuisKumulatif" hideBarsOnScroll>
                <Navbar sliding={false} backLink="Kembali" onBackClick={this.backClick}>
                    <NavTitle sliding>Rekap {this.state.jenisLabel}</NavTitle>
                    <NavTitleLarge>
                        Rekap {this.state.jenisLabel}
                    </NavTitleLarge>
                    <Subnavbar>
                        <Segmented raised>
                            <Button className="color-theme-deeporange" onClick={()=>this.$f7router.navigate('/EmpuKuis/'+this.$f7route.params['jenis'])}>Diskrit</Button>
                            <Button className="color-theme-deeporange" tabLinkActive >Kumulatif</Button>
                        </Segmented>
                    </Subnavbar>
                </Navbar>
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({
      ...
      getRekapKumulatif: Actions.getRekapKumulatif,
      getRekapBulananKumulatif: Actions.getRekapBulananKumulatif
    }, dispatch);
}
...
export default (connect(mapStateToProps, mapDispatchToProps)(EmpuKuisKumulatif));
