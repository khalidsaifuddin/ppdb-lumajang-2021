...
class tambahGuru extends Component {
        ...
        this.setState({
            ...
            this.props.simpanSekolahPengguna(this.state.routeParams).then((result)=>{
                if(result.payload.sukses){
                    ...
                    setTimeout(() => {
                        this.$f7router.navigate("/daftarGuru/"+this.$f7route.params['sekolah_id']);
                    }, 1000);
    ...
    {
        return (
            <Page name="tambahGuru" hideBarsOnScroll>
                <Navbar sliding={false} backLink="Kembali" onBackClick={this.backClick}>
                    <NavTitle sliding>Tambah Guru</NavTitle>
                </Navbar>
                <Row noGap>
                    ...
                    <Col tabletWidth="70" width="100">
                        <Card>
                            <CardContent>
                                Cari guru yang akan ditambahkan ke <b>{this.state.sekolah.nama}</b> menggunakan nama atau email
                                <br/>
