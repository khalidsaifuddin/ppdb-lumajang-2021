...
class kehadiranHarianGuru extends Component {
    state = {
        error: null,
        loading: true,
        loadingKuis: true,
    ...
    loadData = () => {
        ...
        this.setState({
            ...
            this.props.kehadiranHarianGuru(this.state.routeParams).then((result)=>{
                ...
                this.props.kehadiran_harian_guru.map((option)=>{
                ...
                this.props.getPengaturanSekolah(this.state.routeParams).then((result)=>{
                    ...
                    if(result.payload.total > 0){
                        ...
                        // this.$f7.dialog.alert('Sebelum membuka rekap kehadiran guru, mohon tentukan pengaturan kehadiran di pengaturan sekolah terlebih dahulu', 'Peringatan', ()=>{
                            // alert('oke')
                            this.$f7router.navigate("/sekolah/"+this.$f7route.params['sekolah_id'])
                        })    
                    }
    ...
    {
        return (
            <Page name="kehadiranHarianGuru" hideBarsOnScroll>
                <Navbar sliding={false} backLink="Kembali" onBackClick={this.backClick}>
                    <NavTitle sliding>Kehadiran Harian Guru</NavTitle>
                </Navbar>
                <Card>
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({
      ...
      kehadiranHarianGuru: actions.kehadiranHarianGuru,
...
function mapStateToProps({ App, Sekolah, Guru }) {
    return {
        ...
        kehadiran_harian_guru: Guru.kehadiran_harian_guru,
        pengaturan_sekolah: Sekolah.pengaturan_sekolah
    }
}

export default (connect(mapStateToProps, mapDispatchToProps)(kehadiranHarianGuru));
