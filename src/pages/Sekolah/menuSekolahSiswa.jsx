...
class menuSekolahSiswa extends Component {
    state = {
        error: null,
        loading: true,
        loadingKuis: true,
    ...
    {
        return (
            <Page name="menuSekolahSiswa" hideBarsOnScroll>
                <Navbar sliding={false} backLink="Kembali" onBackClick={this.backClick}>
                    <NavTitle sliding>Menu Sekolah untuk Siswa</NavTitle>
                </Navbar>
...
export default (connect(mapStateToProps, mapDispatchToProps)(menuSekolahSiswa));
